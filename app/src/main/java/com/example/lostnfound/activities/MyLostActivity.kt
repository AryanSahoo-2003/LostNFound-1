...
class MyLostActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val courseAdapter = MyLostAdapter(this, courseModelArrayList)
        ...
        courseAdapter.setOnItemClickListener(object : MyLostAdapter.OnItemClickListener{
            override fun OnItemClick(position: Int) {
                ...
                val intentToLostExpanded = Intent(this@MyLostActivity,Lost_Expanded_Description::class.java)
