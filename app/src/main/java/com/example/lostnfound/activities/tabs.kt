...
import com.example.lostnfound.activities.FoundActivity
import com.example.lostnfound.activities.ViewPagerAdapter
...
open class Tabs() : AppCompatActivity(),NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter.addFragment(FoundActivity(), "Found")
        adapter.addFragment(LostActivity(), "Lost")
