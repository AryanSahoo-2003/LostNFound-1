...
class ArchieveLost(private val context: Context, courseModelArrayList: ArrayList<Lost>) :
        ...
        return Viewholder(view).listen { pos, type, flag ->
            ...
            if (flag == 0) {
                ...
                builder.setPositiveButton("Yes") { dialogInterface, which ->
                    ...
                    val user = FirebaseFirestore.getInstance().collection("archivelost")
...
//               builder.show()
                ...
                builder.setPositiveButton("Yes") { dialogInterface, which ->
                    ...
                    FirebaseFirestore.getInstance().collection("archivelost")
