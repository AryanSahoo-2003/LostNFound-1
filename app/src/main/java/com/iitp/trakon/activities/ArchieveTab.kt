...
class ArchieveTab : AppCompatActivity(),NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_archieve_tab)
        ...
        adapter.addFragment(ArchieveFoundFragment(), "Found")
        adapter.addFragment(ArchieveLostFragment(), "Lost")
